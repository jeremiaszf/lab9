...
def _make_call(attempt, payload):
    if attempt == 1:
...
def do_many_things(flag=True, x=10, y=20, z=30):
    ...
    if (
        ...
        print(
            ...
            "probably be validated somewhere else in smaller helper functions",
        )
...
def main():
    ...
    print(do_many_things(True, 12, 25, 30))
